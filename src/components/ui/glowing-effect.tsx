          ...
          style={
            {
              ...
              "--gradient":
                ...
                radial-gradient(circle at 60% 60%, #f5f5f5 10%, #f5f5f500 20%), 
                radial-gradient(circle at 40% 60%, #ffffff 10%, #ffffff00 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #ffffff 0%,
                  #f0f0f0 calc(25% / var(--repeating-conic-gradient-times)),
                  #e5e5e5 calc(50% / var(--repeating-conic-gradient-times)), 
